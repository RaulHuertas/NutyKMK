...
#from kmk.hidble import AbstractHID
...
class BLEKB:
    ...
    def _init_hid(self,isTarget) -> None:
        from kmk.blehid import BLEHID, AbstractHID
        if isTarget:
            print("BLEHID")
    ...
    def before_matrix_scan(self) -> None:
        #print("before_matrix_scan, modules")
        ...
        #print("before_matrix_scan, extensions")
    ...
    def go(self, isTarget=True, **kwargs) -> None:
        try:
            self._init(
                isTarget,
                **kwargs,
