...
def assignKeysWithEncoder ():
    
    
    layer0Asignations = [ KC.NO]*50
    ...
    layer0Asignations[42] =  KC.AUDIO_VOL_DOWN
    layer0Asignations[43] =  KC.AUDIO_VOL_UP

    layer0Asignations[44] =  KC.LGUI
    layer0Asignations[45] =  KC.ENTER
    layer0Asignations[46] =  KC.ESCAPE
    layer0Asignations[47] =  KC.NO
    layer0Asignations[48] =  KC.NO
    layer0Asignations[49] =  KC.NO


    layer1Asignations = [ KC.NO]*50
    #ROW0
    ...
    layer1Asignations[40] =  KC.SPACE
    layer1Asignations[41] =  KC.FD(0)

    layer1Asignations[42] =  KC.AUDIO_VOL_DOWN
    layer1Asignations[43] =  KC.AUDIO_VOL_UP

    layer1Asignations[44] =  KC.LGUI
    layer1Asignations[45] =  KC.ENTER
    layer1Asignations[46] =  KC.APPLICATION
    layer1Asignations[47] =  KC.NO
    layer1Asignations[48] =  KC.NO
    layer1Asignations[49] =  KC.NO


    layer2Asignations = [ KC.NO]*50
    #ROW0
    ...
    layer2Asignations[6] =  KC.NO
    layer2Asignations[7] =  KC.NO
    layer2Asignations[8] =  KC.NO
    ...
    layer2Asignations[18] =  KC.NO
    layer2Asignations[19] =  KC.NO
    layer2Asignations[20] =  KC.NO
    ...
    layer2Asignations[25] =  quixant
    layer2Asignations[26] =  quixant2015
    layer2Asignations[27] =  g920user
    layer2Asignations[28] =  GDP2022_g920
    ...
    layer2Asignations[42] =  KC.AUDIO_VOL_DOWN
    layer2Asignations[43] =  KC.AUDIO_VOL_UP

    layer2Asignations[44] =  KC.LGUI
    layer2Asignations[45] =  KC.ENTER
    layer2Asignations[46] =  KC.FD(0)
    layer2Asignations[47] =  KC.NO
    layer2Asignations[48] =  KC.NO
    layer2Asignations[49] =  KC.NO
